...
@IBDesignable class PhotoSwipeView: UIView {
    ...
    private func loadFromNib() -> UIView {
        ...
        let nib = UINib(nibName: "PhotoSwipeView", bundle: bundle)
    ...
    private func setup() {
        ...
        mainImageView.backgroundColor = UIColor.systemGray5
        mainImageView.frame = self.bounds
        addSubview(mainImageView)
        
        secondaryImageView.backgroundColor = UIColor.systemGray5
